        ...
        <div className="top-menu top-menu-onepage">
          <div className="menu-main-menu-container">
            <ul id="menu-main-menu" className="menu">
              ...
              <li onClick={this.getBtnId} id="2" data-id="menu-item-2" className={this.state.panelIndex === 2 ? cName: ''}><a href="#works" className="one-page-menu-item"><span className='icon'><MdCodeWorking /></span>Gallery</a></li>

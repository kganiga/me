                ...
                <div className="card-inner animated active fadeInRight" id="card-home">
					...
					<div className="content testimonials">
                            ...
                            <section className="card">
                                <img src={require('../../../../assets/images/adobe-certified-master-adobe-experience-manager-sites-architect.png')} alt="adobe experience manager sites architect" />
                                <div className="info">
                                    <h2><a href="https://www.youracclaim.com/badges/8d567595-dc14-41c9-97ca-a86ae57f71b9/public_url" target="_blank" rel="noopener noreferrer">Adobe Certified Master - Adobe Experience Manager Sites Architect</a></h2><h2>
                                        <p> Issued By : <a href="https://www.youracclaim.com/org/adobe">Adobe</a></p>
                                        <br />
                                        <p> Issued September 2020</p>
                                    </h2>
                                    <button className="btn btn--block card__btn"><a href="https://www.youracclaim.com/badges/8d567595-dc14-41c9-97ca-a86ae57f71b9/public_url" target="_blank" rel="noopener noreferrer">See credential</a></button>
                                </div>
                            </section>
                            <section className="card">
                                <img src={require('../../../../assets/images/adobe-certified-expert.png')} alt="adobe experience manager forms developer" />
                                <div className="info">
                                    <h2><a href="https://www.youracclaim.com/badges/aa5e79a2-e3e2-4a15-8a25-1d50498b4ef4/public_url" target="_blank" rel="noopener noreferrer">Adobe Certified Expert - Adobe Experience Manager Forms Developer</a></h2><h2>
                                        <p> Issued By : <a href="https://www.youracclaim.com/org/adobe">Adobe</a></p>
                                        <br />
                                        <p> Issued Jun 2020</p>
                                    </h2>
                                    <button className="btn btn--block card__btn"><a href="https://www.youracclaim.com/badges/aa5e79a2-e3e2-4a15-8a25-1d50498b4ef4/public_url" target="_blank" rel="noopener noreferrer">See credential</a></button>
                                </div>
                            </section>
                            <section className="card">
                                <img src={require('../../../../assets/images/adobe-certified-expert.png')} alt="adobe experience manager sites developer" />
                                <div className="info">
                                    <h2><a href="https://www.youracclaim.com/badges/76285d52-075c-4a4c-ac2d-9c4e5b97ed46/public_url" target="_blank" rel="noopener noreferrer">Adobe Certified Expert - Adobe Experience Manager Sites Developer</a></h2><h2>
                                        <p> Issued By : <a href="https://www.youracclaim.com/org/adobe">Adobe</a></p>
                                        <br />
                                        <p> Issued Jun 2020, Expires Jun 2022 </p>
                                    </h2>
                                    <button className="btn btn--block card__btn"><a href="https://www.youracclaim.com/badges/76285d52-075c-4a4c-ac2d-9c4e5b97ed46/public_url" target="_blank" rel="noopener noreferrer">See credential</a></button>
                                </div>
                            </section>
                            <section className="card">
                                <img src={require('../../../../assets/images/adobe-qualified-adobe-experience-platform.png')} alt="aep certification" />
                                <div className="info">
                                    <h2><a href="https://www.youracclaim.com/badges/76285d52-075c-4a4c-ac2d-9c4e5b97ed46/public_url" target="_blank" rel="noopener noreferrer">Adobe Qualified – Adobe Experience Platform</a></h2><h2>
                                        <p> Issued By : <a href="https://www.youracclaim.com/org/adobe">Adobe</a></p>
                                    </h2>
                                    <button className="btn btn--block card__btn"><a href="https://www.youracclaim.com/badges/76285d52-075c-4a4c-ac2d-9c4e5b97ed46/public_url" target="_blank" rel="noopener noreferrer">See credential</a></button>
                                </div>
                            ...
                            <section className="card">
                                ...
                                <div className="info">
                                    <h2><a href="https://www.youracclaim.com/badges/d498492c-83c5-4305-81a9-1b2ced653169/linked_in_profile" target="_blank" rel="noopener noreferrer">EY Analytics - Data visualization - Bronze</a></h2><h2>
                                        <p> Issued By: <a href="https://www.youracclaim.com/org/ey">EY</a> </p>
                                    </h2>
                                    <button className="btn btn--block card__btn"><a href="https://www.youracclaim.com/badges/d498492c-83c5-4305-81a9-1b2ced653169/linked_in_profile" target="_blank" rel="noopener noreferrer">See credential</a></button>
                                </div>
                            </section>
                            <section className="card">
                                <img src={require('../../../../assets/images/adobe-certified-expert.png')} alt="Adobe Campaign Classic Developer" />
                                <div className="info">
                                    <h2><a href="https://www.youracclaim.com/badges/16b987fd-e045-4ea8-86d3-e019daaaf48b/public_url" target="_blank" rel="noopener noreferrer">Adobe Certified Expert - Adobe Campaign Classic Developer</a></h2><h2>
                                        <p> Issued By : <a href="https://www.youracclaim.com/org/adobe">Adobe</a></p>
                                        <br />
                                        <p> Issued Mar 2020, Expires Mar 2022 </p>
                                    </h2>
                                    <button className="btn btn--block card__btn"><a href="https://www.youracclaim.com/badges/16b987fd-e045-4ea8-86d3-e019daaaf48b/public_url" target="_blank" rel="noopener noreferrer">See credential</a></button>
                                </div>
                            </section>
